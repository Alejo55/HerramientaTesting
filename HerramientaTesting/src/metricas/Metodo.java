...
public class Metodo {
	...
	private String recomendaciones = "CONSIDERACIONES Y SUGERENCIAS:\n";
	...
	public void calcular(List<Metodo> metodos) {
		...
		if(this.porcentajeComentarios < 0.1) {
		...
		if(this.complejidadCiclomatica >= 10) {
			this.recomendaciones += "Complejidad ciclom�tica elevada. Deber�a ser menor a 10.\n";
		}
		if(this.fanOut > 7) {
			this.recomendaciones += "Fan-Out elevado. Es razonable entre 3 y 4, y nunca debe ser mayor a 7. Considere la re-descomposici�n para controlar la complejidad del m�todo.\n";
		}
		if(this.fanIn > 7) {
			this.recomendaciones += "Fan-In elevado. Se recomienda aplicar alg�n m�todo de prueba bastante exhaustivo a dicha funci�n. Por ejemplo, Cobertura de Condici�n-Decisi�n(100% de cobertura).\n";
		}else if(this.fanIn >= 3){
			this.recomendaciones += "Fan-In razonable. Bastar�a con aplicarle alg�n m�todo de prueba que garantice una cobertura mayor al 80%. Por ejemplo, Cobertura de Sentencias, Cobertura de Condici�n o Cobertura de Decisi�n.\n";
		}else {
			this.recomendaciones += "Fan-In bajo. Poca reutilizaci�n de c�digo.\n";
		}
	}
